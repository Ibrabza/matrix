...
import { t as require_react_dom } from "./react-dom-BejBLmt5.js";
import { O as getDependencyTree, X as observable, Y as makeObservable, a as Reaction, at as runInAction, v as configure } from "./mobx.esm-BloO_sOI.js";

//#region node_modules/mobx-react-lite/es/utils/assertEnvironment.js
...
//#endregion
//#region node_modules/mobx-react-lite/es/utils/reactBatchedUpdates.js
var import_react_dom = require_react_dom();

//#endregion
//#region node_modules/mobx-react-lite/es/utils/observerBatching.js
...
//#endregion
//#region node_modules/mobx-react-lite/es/utils/utils.js
...
//#endregion
//#region node_modules/mobx-react-lite/es/utils/printDebugValue.js
function printDebugValue(v) {
	return getDependencyTree(v);
}

//#endregion
//#region node_modules/mobx-react-lite/es/staticRendering.js
...
//#endregion
//#region node_modules/mobx-react-lite/es/utils/UniversalFinalizationRegistry.js
var REGISTRY_FINALIZE_AFTER = 1e4;
var REGISTRY_SWEEP_INTERVAL = 1e4;
var TimerBasedFinalizationRegistry = function() {
	function TimerBasedFinalizationRegistry$1(finalize) {
		var _this = this;
	...
	Object.defineProperty(TimerBasedFinalizationRegistry$1.prototype, "register", {
		enumerable: false,
		configurable: true,
		writable: true,
	...
	Object.defineProperty(TimerBasedFinalizationRegistry$1.prototype, "unregister", {
		enumerable: false,
		configurable: true,
		writable: true,
	...
	Object.defineProperty(TimerBasedFinalizationRegistry$1.prototype, "scheduleSweep", {
		enumerable: false,
		configurable: true,
		writable: true,
		value: function() {
	...
	return TimerBasedFinalizationRegistry$1;
}();
...
//#endregion
//#region node_modules/mobx-react-lite/es/utils/observerFinalizationRegistry.js
var observerFinalizationRegistry = new UniversalFinalizationRegistry(function(adm) {
	var _a$2;
	(_a$2 = adm.reaction) === null || _a$2 === void 0 || _a$2.dispose();
	adm.reaction = null;
});
...
function useObserver$1(render, baseComponentName) {
		...
		var adm_1 = {
			...
			subscribe: function(onStoreChange) {
				...
				return function() {
					...
					(_a$2 = adm_1.reaction) === null || _a$2 === void 0 || _a$2.dispose();
					adm_1.reaction = null;
				};
			},
	...
	import_react.useDebugValue(adm.reaction, printDebugValue);
...
//#endregion
//#region node_modules/mobx-react-lite/es/observer.js
var _a$1, _b;
...
var ReactForwardRefSymbol = hasSymbol ? Symbol.for("react.forward_ref") : typeof import_react.forwardRef === "function" && (0, import_react.forwardRef)(function(props) {
	return null;
})["$$typeof"];
var ReactMemoSymbol = hasSymbol ? Symbol.for("react.memo") : typeof import_react.memo === "function" && (0, import_react.memo)(function(props) {
	return null;
})["$$typeof"];
function observer(baseComponent, options) {
	...
	var useForwardRef = (_a$2 = options === null || options === void 0 ? void 0 : options.forwardRef) !== null && _a$2 !== void 0 ? _a$2 : false;
	...
	Object.defineProperty(observerComponent, "contextTypes", { set: function() {
		var _a$3, _b$1;
		throw new Error("[mobx-react-lite] `".concat(this.displayName || ((_a$3 = this.type) === null || _a$3 === void 0 ? void 0 : _a$3.displayName) || ((_b$1 = this.type) === null || _b$1 === void 0 ? void 0 : _b$1.name) || "Component", ".contextTypes` must be set before applying `observer`."));
	} });
...
//#endregion
//#region node_modules/mobx-react-lite/es/ObserverComponent.js
function ObserverComponent(_a$2) {
	var children = _a$2.children, render = _a$2.render;
...
//#endregion
//#region node_modules/mobx-react-lite/es/useLocalObservable.js
...
//#endregion
//#region node_modules/mobx-react-lite/es/useAsObservableSource.js
function useAsObservableSource(current) {
	...
	var res = (0, import_react.useState)(function() {
...
//#endregion
//#region node_modules/mobx-react-lite/es/useLocalStore.js
...
//#endregion
//#region node_modules/mobx-react-lite/es/index.js
var _a;
